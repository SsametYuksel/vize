...
class ModelCatalogProduct extends Model {
	...
	public function editProduct($product_id, $data) {
		...
		. "', passport_type_allowance = '" . $this->db->escape($data['passport_type_allowance']) 
		. "', need_supporting_docs = '" . $this->db->escape($data['need_supporting_docs']) 
		. "', max_stay_days = '" . $this->db->escape($data['max_stay_days']) 
		. "', extra_passport_note = '" . $this->db->escape($data['extra_passport_note']) 
	...
	public function getProductCategoriesName($product_id) {
		...
		$query = $this->db->query(
			"SELECT * FROM " . DB_PREFIX . "product_to_category pc
		...
		return implode(',', $product_category_data);
	}
	...
	public function getProductOptionsCustom($product_id) {
		$sql = "SELECT ovd.name, pov.price FROM `" . DB_PREFIX . "product_option_value` pov
		...
		// echo $sql;
		// exit;
		// print_r($this->db->query($sql)->rows)[0]['options']; exit;
