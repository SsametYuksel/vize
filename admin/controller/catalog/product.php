	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$data['products'][] = array(
				...
				'name'       => $result['name'],
				'model'      => $result['model'],
				'category'   => $this->model_catalog_product->getProductCategoriesName($result['product_id']),
				'options'   => $this->model_catalog_product->getProductOptionsCustom($result['product_id']),
				'price'      => $result['price'],
				'special'    => $special,
