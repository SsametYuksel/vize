      ...
      <div class="panel-body">
        <form action="POST"  class="form-horizontal">
          <ul id="order" class="nav nav-tabs nav-justified">
            <li class="disabled active"><a href="#tab-customer" data-toggle="tab"><?php echo $tab_customer; ?></a></li>
          </ul>
          <div class="tab-content">
            <div class="tab-pane active" id="tab-customer">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-lastname">Surname: </label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-birthdate">Birthdate: </label>
                <div class="col-sm-10">
                  <input type="text" name="email" value="<?php echo $birthdate; ?>" id="input-birthdate" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-birthplace">Phone number: </label>
                <div class="col-sm-10">
                  <input type="text" name="birthplace" value="<?php echo $birthplace; ?>" id="input-birthplace" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-passport_number">Passport number: </label>
                <div class="col-sm-10">
                  <input type="text" name="passport_number" value="<?php echo $passport_number; ?>" id="input-passport_number" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="fax" value="<?php echo $telephone; ?>" id="input-phone"
                         class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-residence_address">Residence address</label>
                <div class="col-sm-10">
                  <input type="text" name="fax" value="<?php echo $residence_address; ?>" id="input-residence_address" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-passport_issue_date">Passport issue date: </label>
                <div class="col-sm-10">
                  <input type="text" name="fax" value="<?php echo $passport_issue_date; ?>" id="input-fax" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-fax">Passport number:</label>
                <div class="col-sm-10">
                  <input type="text" name="fax" value="<?php echo $passport_number; ?>" id="input-fax" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-fax">Passport expiry date:</label>
                <div class="col-sm-10">
                  <input type="text" name="fax" value="<?php echo $passport_expiry_date; ?>" id="input-fax" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-arrival_date">Arrival date:</label>
                <div class="col-sm-10">
                  <input type="text" name="fax" value="<?php echo $arrival_date; ?>" id="input-fax" class="form-control" />
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-supporting_document_type"><?php echo $entry_fax; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="fax" value="<?php echo $supporting_document_type; ?>" id="input-supporting_document_type" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-supporting_document"><?php echo $entry_fax; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="fax" value="<?php echo $supporting_document; ?>" id="input-supporting_document" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-supporting_document_number"><?php echo $entry_fax; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="fax" value="<?php echo $supporting_document_number; ?>" id="input-supporting_document_number" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-supporting_document_expiry_date"><?php echo $entry_fax; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="fax" value="<?php echo $supporting_document_expiry_date; ?>" id="input-supporting_document_expiry_date" class="form-control" />
                </div>
              </div>
              ...
              <div class="text-right">
                <button type="submit" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i
                          class="fa fa-arrow-right"></i> Save</button>
              </div>
            </div>
          </div>
        </form>
