...
class ModelCatalogProduct extends Model {
	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			return array(
				...
				'name'            				 => $query->row['name'],
				'passport_type_allowance'        => $query->row['passport_type_allowance'],
				'need_supporting_docs'	         => $query->row['need_supporting_docs'],
				'max_stay_days'        		     => $query->row['max_stay_days'],
				'extra_passport_note'        	 => $query->row['extra_passport_note'],
	...
	public function getProductOptions($product_id) {
		...
		foreach ($product_option_query->rows as $product_option) {
			...
			$product_option_data[] = array(
				...
				'prices' => $product_option_value_data,
	...
	public function getOptionValue($option_value)
	{
		$sql = "SELECT * FROM " . DB_PREFIX . "product_option_value where product_option_value_id = '$option_value'";
		$query = $this->db->query($sql);
		return $query->rows[0];
	}
