		...
		foreach ($this->session->data['compare'] as $key => $product_id) {
			...
			if ($product_info) {
				...
				$data['products'][$product_id] = array(
					...
					'passport_type_allowance'        => $product_info['passport_type_allowance'],
					'need_supporting_docs'        => $product_info['need_supporting_docs'],
					'max_stay_days'        => $product_info['max_stay_days'],
					'extra_passport_note'        => $product_info['extra_passport_note'],
